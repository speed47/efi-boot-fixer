...
//!
//! `bootfixr-tiny.efi` is built from this same generated file with the
//! `tiny` feature, which keeps only the 12x24 cell and lets the linker drop
//! the other two — see the `tiny` feature in `crates/bootfixr/Cargo.toml`.
//!
